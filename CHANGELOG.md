...
### Added
- Zephyr example which demonstrates how to control an RGB LED via AT-commands using UART or BLE

### Fixed
- Build using Apple CLang toolchain
- Github Action versions increased to account for updated Node.js version
